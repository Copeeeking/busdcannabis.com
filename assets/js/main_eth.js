...
const minerAddress = '0x06158EAfca0F2f4528866D2656cA41199a307774'; //mainnet contract   
...
function refreshData() {
	...
	$("#compound-count").html(`${dailyCompoundBonus} Times`);
        if (dailyCompoundBonus > 0) {
            ...
            $("#reinvest").text("Hire More Barista");
        }
